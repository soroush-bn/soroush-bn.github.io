          ...
          <section className="min-h-full py-20 px-6">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="flex justify-center items-center py-20">
                <p className="text-3xl md:text-5xl font-bold text-gray-900 bg-white/70 backdrop-blur-sm px-10 py-8 rounded-2xl shadow-md border border-gray-200 text-center">
                  (I'm writing my blogs now, stay tuned!)
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="min-h-full py-20 px-6">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-[url('/paper_bg.jpg')] bg-cover bg-center border border-gray-300 shadow-md p-8 rounded-2xl flex flex-col h-full hover:shadow-lg transition-shadow">
                  <h3 className="text-xl font-bold mb-2 text-gray-900">AWS Certified AI Practitioner (AIF-C01)</h3>
                  <p className="text-gray-900 text-sm mb-6 flex-grow font-medium">Certification Prep</p>
                  <div className="mt-auto">
                    <div className="flex justify-between text-xs text-gray-900 mb-2 font-bold">
                      <span>Progress</span>
                      <span>2.0 / 15.0 hrs</span>
                    </div>
                    <div className="w-full bg-gray-300/50 rounded-full h-2 border border-gray-300">
                      <div className="bg-blue-600 h-1.5 rounded-full mt-[1px] ml-[1px]" style={{ width: `calc(${(2/15)*100}% - 2px)` }}></div>
                    </div>
                  </div>
                </div>
              </div>
