  ...
  return (
    <main className="h-screen w-screen overflow-hidden bg-gray-100 text-gray-900 font-sans flex flex-col selection:bg-blue-200 relative text-xl">
      ...
      <div className="flex-1 relative overflow-hidden z-10">
        ...
        <div className={`absolute inset-0 overflow-y-auto transition-all duration-700 ease-in-out ${activeSection === '#home' ? 'opacity-100 z-10 translate-y-0' : 'opacity-0 z-0 translate-y-8 pointer-events-none'}`}>
          <section className="min-h-full flex items-center justify-center py-20 px-6">
            <div className="max-w-4xl text-center">
              ...
              <h2 className="text-xl md:text-2xl text-blue-800 font-bold mb-10 bg-white/70 px-6 py-3 rounded-xl inline-block backdrop-blur-sm shadow-sm">
        ...
        {/* Research Section */}
        <div className={`absolute inset-0 overflow-y-auto transition-all duration-700 ease-in-out ${activeSection === '#research' ? 'opacity-100 z-10 translate-y-0' : 'opacity-0 z-0 translate-y-8 pointer-events-none'}`}>
        ...
        {/* Projects Section */}
        <div className={`absolute inset-0 overflow-y-auto transition-all duration-700 ease-in-out ${activeSection === '#projects' ? 'opacity-100 z-10 translate-y-0' : 'opacity-0 z-0 translate-y-8 pointer-events-none'}`}>
          <section className="min-h-full py-20 px-6">
